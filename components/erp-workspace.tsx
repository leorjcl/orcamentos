...
type View = "dashboard" | "pricing" | "products" | "settings" | "quotes";
...
export function ErpWorkspace({ view }: { view: View }) {
  ...
  const titles = { dashboard: "Visão geral", pricing: "Precificação", products: "Produtos e serviços", settings: "Configurações", quotes: "Orçamentos e pedidos" };
  ...
  return <div className="erp-shell">
    ...
    <div className="workspace">
      ...
      <main id="main-content" className="main-content">
        {view !== "quotes" && <div className="local-banner"><Icon name="file" size={17} /><span><strong>Prévia do novo ERP.</strong> Rascunhos ficam apenas neste navegador. Precificações ainda não são sincronizadas com o WordPress.</span></div>}
